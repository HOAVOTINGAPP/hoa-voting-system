...
<div class="card">
  ...
  <p class="subtle">ERFs linked to the developer are blocked from individual voting.</p>
  <table>
...
""" + BASE_TAIL
    return render_template_string(template, regs=regs, dev_proxy_erfs=dev_proxy_erfs)
...
<div class="card">
  ...
  <table>
      ...
      <tr>
          ...
          <td>
            {% if dev_active %}
              <a href="{{ url_for('admin_developer_vote', topic_id=t['id']) }}">Record Developer Vote</a>
            {% else %}
...
<div class="card">
  ...
  <p class="subtle">
    ...
    Any ERF linked as a developer proxy cannot log in to vote individually.
  </p>
  ...
  <form method="post">
      ...
      <p>
        <label>Developer base votes (e.g. unsold units):<br>
  ...
  <p class="subtle">
    Each ERF linked here is considered represented by the developer and is <strong>blocked</strong> from individual voting.
  </p>
  <form method="post">
...
""" + BASE_TAIL
    return render_template_string(template, settings=settings, proxies=proxies)
